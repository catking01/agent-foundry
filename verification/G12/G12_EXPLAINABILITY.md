...
|---|---|---|---|---|---|---|
| Speed First | Yes (evidence integrity failure) | 16 | 10.6 | 4 | 7 | planning |
| Quality First | Yes (bankruptcy) | 31 | 19.8 | 7 | 8 | engineering |
| Parallel Heavy | No | 27 | 25.2 | 5 | 5 | engineering |
| Balanced | No | 34 | 41.0 | 6 | 6 | engineering |

> Table generated by `generateAttributionReport(42, 100)` — machine-consistent with FAILURE_ATTRIBUTION_REPORT.json.
...
| Attribution hygiene: 0 invalid reasons | PASS |
| Report markdown ↔ JSON consistency | PASS |
