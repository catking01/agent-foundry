      ...
      {stages.map((stage) => {
        ...
        return (
          <div key={stage} className="panel">
            <h2>
              {stage.toUpperCase()} ({tasks.length} tasks)
...
function TaskRow({
  ...
  return (
    <div className="card">
      ...
      >
        <span>
          Remaining: {Math.round(task.remainingWork)} | C:{task.complexity} A:
          {task.ambiguity}
        </span>
        <span>
